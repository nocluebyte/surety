...
<ul class="nav nav-tabs nav-light-info nav-bold  ">
    ...
    <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#approve_bond_cancellation">
            <span class="nav-icon"><i class="flaticon2-pie-chart-4"></i></span>
            <span class="nav-text">{{ __('cases.bond_cancellation') }}</span>
        </a>
    </li>
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#approve_bond_foreclosure">
            <span class="nav-icon"><i class="flaticon2-pie-chart-4"></i></span>
            <span class="nav-text">{{ __('cases.bond_foreclosure') }}</span>
        </a>
    </li>
     <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#approve_bond_invoked">
            <span class="nav-icon"><i class="flaticon2-pie-chart-4"></i></span>
            <span class="nav-text">{{ __('cases.bond_invoked') }}</span>
        </a>
    </li>
</ul>
                    ...
                    @forelse ($approved_bond_current as $decision)
                        <tr>
                            ...
                            <td class="text-center">
                                @if(isset($decision->decision_status))
    ...
    <div class="tab-pane fade show" id="approve_bond_past" role="tabpanel">
     ...
     <div class="tab-pane fade show" id="approve_bond_reject" role="tabpanel">
        ...
        <div class="row">
         ...
         <div class="tab-pane fade show" id="approve_bond_invoked" role="tabpanel">
        <div class="row">
            <table class="table table-responsive">
                <thead>
                    <tr>
