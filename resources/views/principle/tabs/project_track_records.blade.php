        ...
        <div class="repeaterRow ptr_repeater_row" data-repeater-list="ptr_items">
            @foreach ($project_track_records as $item)
                <div class="row mb-5 ptr_row" data-row-index="{{ $loop->iteration }}" data-repeater-item="" style="border-bottom: 1px solid grey;">
                    {!! Form::hidden('ptr_id', $item->id ?? '', ['class' => 'jsPtrId']) !!}
                    ...
                    <div class="col-4 form-group">
                        ...
                        {!! Form::date('project_start_date', $item->project_start_date ?? null, ['class' => 'form-control ptr_project_start_date jsPtrPeriod', 'min' => '1000-01-01', 'max' => '9999-12-31',]) !!}
                    </div>

                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.project_end_date'), __('principle.project_end_date')) !!}
                        {!! Form::date('project_end_date', $item->project_end_date ?? null, ['class' => 'form-control ptr_project_end_date jsPtrPeriod jsPtrEndDate',]) !!}
                    </div>

                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.project_tenor'), __('principle.project_tenor')) !!}
                        {!! Form::text('project_tenor', $item->project_tenor ?? null, [
                            'class' => 'form-control number jsPtrProjectTenor form-control-solid',
                            'name' => 'project_tenor',
                            'data-rule-Numbers' => true,
                            'readonly',
                        ]) !!}
                    ...
                    <div class="col-4 form-group">
                        ...
                        {!! Form::date('actual_date_completion', $item->actual_date_completion ?? null, [
                            'class' => 'form-control actual_date_completion minDate statusDate',
                            // 'min' => '1000-01-01',
                            // 'max' => '9999-12-31',
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.bg_amount'), __('principle.bg_amount')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <div class="d-block jsDivClass">
                            {!! Form::file('project_track_records_attachment', [
                                'class' => 'project_track_records_attachment jsDocument',
                                'id' => 'project_track_records_attachment',
                                // empty($dms_data) ? '' : '',
                                'multiple',
                                'maxfiles' => 5,
                            ...
                            <a href="#" data-toggle="modal" data-repeater-row="ptr_row" data-target="#ptr_attachment_{{ $item->id }}"
                                class="call-modal jsRepeaterShowDocument navi-link {{ $dsbtcls }}" data-delete="jsProjectTrackRecordsAttachmentDeleted" data-prefix="project_track_records_attachment"><i class="fa fa-file" aria-hidden="true"></i>&nbsp;
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;
                                                                    <a type="button" class="dms_project_track_records_attachment_{{ $documents->id }}">
                                                                        <i class="flaticon2-cross small remove_repeater_attachment" data-repeater-row="ptr_row" data-prefix="project_track_records_attachment" data-url="{{ route('removeDmsAttachment') }}"
    ...
    @else
        <div class="repeaterRow ptr_repeater_row" data-repeater-list="ptr_items">
            <div class="row mb-5 ptr_row" data-row-index="1" data-repeater-item="" style="border-bottom: 1px solid grey;">
                <input type="hidden" name="ptr_id" class="jsPtrId">
                <div class="col-6 form-group">
                    {!! Form::label(__('principle.project_name'), __('principle.project_name')) !!}
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.project_start_date'), __('principle.project_start_date')) !!}
                    {!! Form::date('project_start_date', null, ['class' => 'form-control ptr_project_start_date jsPtrPeriod', 'min' => '1000-01-01', 'max' => '9999-12-31',]) !!}
                </div>

                <div class="col-4 form-group">
                    {!! Form::label(__('principle.project_end_date'), __('principle.project_end_date')) !!}
                    {!! Form::date('project_end_date', null, ['class' => 'form-control ptr_project_end_date jsPtrPeriod jsPtrEndDate',]) !!}
                </div>
                ...
                <div class="col-4 form-group">
                    ...
                    <div class="d-block jsDivClass">
                        ...
                        <a href="#" data-toggle="modal" data-repeater-row="ptr_row" data-target="#ptr_attachment"
                            class="call-modal jsRepeaterShowDocument navi-link {{ $dsbtcls }}" data-delete="jsProjectTrackRecordsAttachmentDeleted" data-prefix="project_track_records_attachment"><i class="fa fa-file" aria-hidden="true"></i>&nbsp;
