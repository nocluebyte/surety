            ...
            @foreach ($proposal_banking_limits as $item)
                <div class="row mb-5 pbl_row" data-row-index="{{ $loop->iteration }}" data-repeater-item="" style="border-bottom: 1px solid grey;">
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.banking_category_id'), __('principle.banking_category_label')) !!}
                        ...
                        {!! Form::select(
                            ...
                            [
                                'class' => 'form-control banking_category_id jsSelect2ClearAllow',
                                'style' => 'width:100%;',
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.facility_type_id'), __('principle.facility_types_label')) !!}

                        {!! Form::select('facility_type_id', ['' => 'Select Facility Type'] + $facility_types, $item->facility_type_id, [
                            'class' => 'form-control facility_type_id jsSelect2ClearAllow',
                            'style' => 'width:100%;',
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.sanctioned_amount'), __('principle.sanctioned_amount')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.bank_name'), __('principle.bank_name')) !!}
                    ...
                    <div class="col-4 form-group">
                        {{-- {{ Form::label(__('principle.latest_limit_utilized_date'), __('principle.latest_limit_utilized_date')) }}<i
                        ...
                        {!! Form::label(__('principle.latest_limit_utilized'), __('principle.latest_limit_utilized')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.unutilized_limit'), __('principle.unutilized_limit')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.commission_on_pg'), __('principle.commission_on_pg')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-4 form-group">
                        {!! Form::label(__('principle.commission_on_fg'), __('principle.commission_on_fg')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-4 form-group 111">
                        {!! Form::label(__('principle.margin_collateral'), __('principle.margin_collateral')) !!}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        {!! Form::file('banking_limits_attachment', [
                            ...
                            'class' => 'banking_limits_attachment',
                            'multiple',
                        ]) !!}
                        ...
                        <div class="d-block jsDivClass">
                            {!! Form::file('banking_limits_attachment', [
                                'class' => 'banking_limits_attachment jsDocument',
                                'id' => 'banking_limits_attachment',
                                'multiple',
                                'maxfiles' => 5,
                            ...
                            <a href="#" data-toggle="modal" data-repeater-row="pbl_row" data-target="#pbl_attachment_{{ $loop->iteration }}"
                                class="call-modal jsRepeaterShowDocument navi-link {{ $dsbtcls }}" data-delete="jsBankingLimitsAttachmentDeleted" data-prefix="banking_limits_attachment"><i class="fa fa-file" aria-hidden="true"></i>&nbsp;
                                                    ...
                                                    <table>
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>&nbsp;
                                                                    <a type="button" class="dms_banking_limits_attachment_{{ $documents->id }}">
                                                                        <i class="flaticon2-cross small remove_repeater_attachment" data-repeater-row="pbl_row" data-prefix="banking_limits_attachment" data-url="{{ route('removeDmsAttachment') }}"
    ...
    @else
        <div class="repeaterRow pbl_repeater_row" data-repeater-list="pbl_items">
            <div class="row mb-5 pbl_row" data-row-index="1" data-repeater-item="" style="border-bottom: 1px solid grey;">
                <input type="hidden" name="pbl_id" class="jsPblId">
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.banking_category_id'), __('principle.banking_category_label')) !!}
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.sanctioned_amount'), __('principle.sanctioned_amount')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-4 form-group">
                    {{-- {{ Form::label(__('principle.latest_limit_utilized_date'), __('principle.latest_limit_utilized_date')) }}<i class="text-danger">*</i>
                    ...
                    {!! Form::label(__('principle.latest_limit_utilized'), __('principle.latest_limit_utilized')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.unutilized_limit'), __('principle.unutilized_limit')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.commission_on_pg'), __('principle.commission_on_pg')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.commission_on_fg'), __('principle.commission_on_fg')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-4 form-group">
                    {!! Form::label(__('principle.margin_collateral'), __('principle.margin_collateral')) !!}<span class="currency_symbol"></span>
                ...
                <div class="col-6 form-group">
                    ...
                    <div class="d-block jsDivClass">
                        ...
                        <a href="#" data-toggle="modal" data-repeater-row="pbl_row" data-target="#pbl_attachment"
                            class="call-modal jsRepeaterShowDocument navi-link {{ $dsbtcls }}" data-delete="jsBankingLimitsAttachmentDeleted" data-prefix="banking_limits_attachment"><i class="fa fa-file" aria-hidden="true"></i>&nbsp;
                            <span class = "count_banking_limits_attachment" data-count_banking_limits_attachment = "0"></span>
                        </a>

                        <div class="modal fade" tabindex="-1" id="pbl_attachment">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Principle/Contractor Documents</h5>
