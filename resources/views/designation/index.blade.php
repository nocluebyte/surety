@extends($theme)
@section('title', __('designation.designation'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('designation.designation'),
        'add_modal' => collect([
            'action' => route('designation.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['designation.add', 'users.superadmin']),
    ])
    @endcomponent
