    ...
    <div class="d-flex flex-column-fluid">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        @if($current_user->hasAnyAccess(['users.superadmin', 'principle.list']))
                            <a href={{ route('principle.index') }} target="_blank">
                                <div class="card-body p-4">
                                    <span
                                        class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{ $totalContractor ?? '0' }}</span>
                                    <span class="font-weight-bold text-dark-50 font-size-lg">Total Contractor</span>
                                </div>
                            </a>
                        @else
                            <div class="card-body p-4">
                ...
                <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        @if($current_user->hasAnyAccess(['users.superadmin', 'beneficiary.list']))
                            <a href="{{ route('beneficiary.index') }}" target="_blank">
                                <div class="card-body p-4">
                                    <span
                                        class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{ $totalBeneficiary ?? '0' }}</span>
                                    <span class="font-weight-bold text-dark-50 font-size-lg">Total Beneficiary</span>
                                </div>
                            </a>
                        @else
                            <div class="card-body p-4">
                ...
                <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        @if($current_user->hasAnyAccess(['users.superadmin', 'proposals.list']))
                            <a href="{{ route('proposals.index') }}" target="_blank">
                                <div class="card-body p-4">
                                    <span
                                        class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{ $totalProposals ?? '0' }}</span>
                                    <span class="font-weight-bold text-dark-50 font-size-lg">Total Proposals</span>
                                </div>
                            </a>
                        @else
                            <div class="card-body p-4">
                ...
                <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-body p-4">
                            <span
                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{numberFormatPrecision($premium_amount,0)}}</span>
                            <span class="font-weight-bold text-dark-50 font-size-lg">Total Net Premium</span>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-body p-4">
                            <span
                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{numberFormatPrecision($average_rate_of_portfolio,2)}}</span>
                            <span class="font-weight-bold text-dark-50 font-size-lg">Average Rate of Portfolio</span>
                        </div>
                    </div>
                </div> --}}
                ...
                <div class="col-xl-3">
                    <div class="card card-custom card-stretch gutter-b">
                        <div class="card-body p-4">
                            <span
                                class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 d-block">{{numberFormatPrecision($current_exposure,0)}}</span>
                            <span class="font-weight-bold text-dark-50 font-size-lg">Live Risk Exposure</span>
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(function() {
            const apexChart = "#BondTypeChart";

            var options = {
                series: [{
                    data: [<?= implode(',', $bondTypes) ?>],
                }],
                chart: {
                    type: 'bar',
                    height: 350
                ...
                xaxis: {
                    categories: [<?= "'" . implode("', '", array_keys($bondTypes)) . "'" ?>],
                },
            };
        ...
        // $(function() {
        //     const apexChart = "#BondIssueChart";
        ...
        //             floating: true
        //         },
        //         series: {!! json_encode($bond_issued_month_wise ?? []) !!},
        ...
        // $(function() {
        //     const apexChart = "#SectorWiseNbiChart";

        //     var options = {
        //         series: [<?= implode(',', $nbiCount ??[]) ?>],
        //         chart: {
        //             width: '100%',
        //             type: 'donut',
        //             stacked: false,
        ...
        //             }
        //         },
        //         labels: [<?= "'" . implode("', '", array_keys($nbiCount ??[])) . "'" ?>],
        //         legend: {
        //             show: false
        //         },
        //         dataLabels: {
