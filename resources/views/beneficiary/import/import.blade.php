    ...
    <div class="container-fluid">
        ...
        <div class="card card-custom gutter-b">
            @if (session()->has('excel_error') && count(session()->get('excel_error')) > 0)
                <div class="card-body">
                    <div class="row float-right">
                        <div class="col"></div>
                        <div class="col mb-5">
                            {!! Form::open(['route' => 'beneficiaryImportErrorExport', 'method' => 'POST']) !!}
                    ...
                    @include('beneficiary.export.beneficiary_import_error_export', [
            ...
            @else
                <div class="card-body">
                    {!! Form::open([
                        'route' => 'beneficiary_data_import',
                        'enctype' => 'multipart/form-data',
                        'method' => 'POST',
                        'id' => 'beneficiary_import_form',
                    ]) !!}
                    @csrf
                        ...
                        <div class="form-group col-lg-12 px-0 mb-0">
                            <div class="row">
                                <div class="form-group col-lg-12 text-right">
                                    <a href="{{ url('/excel/beneficiary_bulk_upload.xls') }}" class="btn btn-success btn-sm mr-3">
                                        <i class="flaticon-download-1"></i>{{ __('beneficiary.demo_file') }}</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-4">
                                    <label>{{ __('beneficiary.upload_file') }}<span class="text-danger">*</span></label>
                                    <div class="">
...
@include('beneficiary.import.script')