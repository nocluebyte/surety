...
'model_back_action' => route('report.contractor-wise.index'),
'filter_modal_id' => '#contractor_wise_filter',
'excel_id'=> '',
'excel_link' => route('report.contractor-wise-report-excel', ['checked_fields' => $checked_fields, 'contractor' => $contractor_filter, 'selected_status' => $selected_status]),
...
@component('components.report-modal', [
    'action'=>'report.contractor-wise.show',
...
@endcomponent
@include('reports.contractor_wise.filter')
@endsection
...
<script type="text/javascript">
    ...
    let url = {{Js::from(route('report.contractor-wise.datalist'))}};

    // Initialize the load more function
