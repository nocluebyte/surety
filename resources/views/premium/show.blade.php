            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    <div class="card-title font-weight-bolder text-dark">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" id="bid-bond-tab-overview" data-toggle="tab" href="#bid-bond-overview">
                                <span class="nav-text">{{ __('bid_bond.overview') }}</span>
                            </a>
                        </li>
                        @if ($current_user->hasAnyAccess(['bid_bond.nbi_view', 'users.superadmin']))
                        <li class="nav-item">
                            <a class="nav-link" id="bid-bond-tab-nbi" data-toggle="tab" href="#bid-bond-nbi">
                                <span class="nav-text">{{ __('bid_bond.nbi') }}</span>
                            </a>
                        </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link" id="bid-bond-tab-amendment-history" data-toggle="tab" href="#bid-bond-amendment-history">
                                <span class="nav-text">{{ __('bid_bond.amendment_history') }}</span>
                            </a>
                        </li>
                    </ul> --}}
                    </div>
                        ...
                        <table style="width:100%">
                            <tr>
                                <td class="width_15em text-light-grey">
                                    {{ __('bond_policies_issue.premium_amount') }}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                                </td>
                                <td>:</td>
                                ...
                                <td class="width_15em text-light-grey">
                                    {{ __('bond_policies_issue.net_premium') }}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                                </td>
                                <td>:</td>
                                <td class="width_15em text-black">
                            ...
                            <tr>
                                ...
                                @if ($bond_policy_issue_checklist->executed_deed_indemnity == 'Yes')
                                    ...
                                    <td class="width_15em text-black">
                                        ...
                                        <div class="modal fade" id="deed_attach_document_modal" tabindex="-1"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div data-scroll="true" data-height="100">
                                                            @if (isset($issue_checklist_dms) &&
                                                                    isset($issue_checklist_dms['deed_attach_document']) &&
                                                                    count($issue_checklist_dms['deed_attach_document']) > 0)
                            ...
                            <tr>
                                ...
                                @if ($bond_policy_issue_checklist->executed_board_resolution == 'Yes')
                                    ...
                                    <td class="width_15em text-black">
                                        ...
                                        <div class="modal fade" id="board_attach_document_modal" tabindex="-1"
                                            role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <div data-scroll="true" data-height="100">
                                                            @if (isset($issue_checklist_dms) &&
                                                                    isset($issue_checklist_dms['board_attach_document']) &&
                                                                    count($issue_checklist_dms['board_attach_document']) > 0)
                            ...
                            <tr>
                                ...
                                @if ($bond_policy_issue_checklist->broker_mandate == 'Broker')
                                    ...
                                    <td class="width_15em text-black">
                                        <a type="button" data-toggle="modal"
                                            data-target="#broker_attach_document_modal">
                                            <i class="fas fa-file"></i>
                                        </a>
                                        <div class="modal fade" id="broker_attach_document_modal" tabindex="-1"
                                            role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Broker Attach
                                                            Document
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                    ...
                                                    <div class="modal-body">
                                                        <div data-scroll="true" data-height="100">
                                                            @if (isset($issue_checklist_dms) &&
                                                                    isset($issue_checklist_dms['broker_attach_document']) &&
                                                                    count($issue_checklist_dms['broker_attach_document']) > 0)
                                ...
                                @elseif ($bond_policy_issue_checklist->broker_mandate == 'Agent')
                                    ...
                                    <td class="width_15em text-black">
                                        ...
                                        <div class="modal fade" id="agent_attach_document_modal" tabindex="-1"
                                            role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Agent Attach
                                                            Document
                                                        </h5>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close">
                                                    ...
                                                    <div class="modal-body">
                                                        <div data-scroll="true" data-height="100">
                                                            @if (isset($issue_checklist_dms) &&
                                                                    isset($issue_checklist_dms['agent_attach_document']) &&
                                                                    count($issue_checklist_dms['agent_attach_document']) > 0)
                            ...
                            <tr>
                                <td class="width_15em text-light-grey">
                                    {{ __('bond_policies_issue.fd_amount') }}<span class="currency_symbol">{{ isset($currency_symbol) ? ' (' .$currency_symbol . ')' : '' }}</span>
                                </td>
                                <td>:</td>
                                <td class="width_15em text-black">
                            ...
                            <tr>
                                ...
                                <td class="width_15em text-black">
                                    <a type="button" data-toggle="modal"
                                        data-target="#collateral_attach_document_modal">
                                        <i class="fas fa-file"></i>
                                    </a>
                                    <div class="modal fade" id="collateral_attach_document_modal" tabindex="-1"
                                        role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Collateral Attach
                                                        Document
                                                    </h5>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                ...
                                                <div class="modal-body">
                                                    <div data-scroll="true" data-height="100">
                                                        @if (isset($issue_checklist_dms) &&
                                                                isset($issue_checklist_dms['collateral_attach_document']) &&
                                                                count($issue_checklist_dms['collateral_attach_document']) > 0)
