@extends($theme)
@section('title', __('establishment_types.establishment_types'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('establishment_types.establishment_types'),
        'add_modal' => collect([
            'action' => route('establishment_types.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['establishment_types.add', 'users.superadmin']),
    ])
    @endcomponent
                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="dataTableBuilder">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="d-none"></th>
                                <th>{{ __('establishment_types.name') }}</th>
...
@section('scripts')
    <script type="text/javascript">
        let name = "{{ __('establishment_types.name') }}";
