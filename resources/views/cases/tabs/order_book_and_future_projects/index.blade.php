<div class="table-responsive">
    <table class="table" style="width:100%;">
        <div class="container">
            ...
            @if (isset($case->contractor->orderBookAndFutureProjects) && $case->contractor->orderBookAndFutureProjects->count() > 0)
                @foreach($case->contractor->orderBookAndFutureProjects->sortDesc() as $item)
                    <tbody>
                        <tr>
