@push('scripts')
    <script type="text/javascript">
        ...
        $('.jsBondNumber').change(function(){
            let element = $(this);
            let invocation_id = element.val();
            let url = element.data().ajaxurl;
            ...
            $.ajax({
                    ...
                    $('.jsInvocationNotification').val(response.invocation_notification_id);
                    $('.jsRecoveryAmount').attr('data-rule-max',response.total_outstanding_amount);
                    $('.jsInvocationNumber').val(response.invocation_number);
                    $('.jsBondValue').val(response.bond_value);
                    $('.jsInvocationRemark').val(response.invocation_remark);
                    $('.jsClaimedAmount').val(response.claimed_amount);
                    $('.jsDisallowedAmount').val(response.disallowed_amount);
                    $('.jsTotalApprovedBondValue').val(response.total_approved_bond_value);
