@extends($theme)
@section('title', __('file_source.file_source'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('file_source.file_source'),
        'add_modal' => collect([
            'action' => route('file_source.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['file_source.add', 'users.superadmin']),
    ])
    @endcomponent
