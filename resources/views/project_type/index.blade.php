@extends($theme)
@section('title', __('project_type.project_type'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('project_type.project_type'),
        'add_modal' => collect([
            'action' => route('project_type.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['project_type.add', 'users.superadmin']),
    ])
    @endcomponent
