@extends($theme)
@section('title', __('principle_type.principle_type'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('principle_type.principle_type'),
        'add_modal' => collect([
            'action' => route('principle_type.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['principle_type.add', 'users.superadmin']),
    ])
    @endcomponent
...
@section('scripts')
    <script type="text/javascript">
        let name = "{{ __('principle_type.name') }}";
