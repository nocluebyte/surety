                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2 pb-10">
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column pb-2 pl-1 pr-1 pt-4 ">
                                    <a href="{{ route('dms.show', [encryptId($principle->id), 'proposal_id' => encryptId($item->id), 'contractor_id' => encryptId($contractor_id), 'dmsable_type' => encryptId('Nbi'), 'type' => encryptId('indemnity_letter_document_view')]) }}" class="text-gray-800 text-hover-primary d-flex flex-column" target="_blank">
