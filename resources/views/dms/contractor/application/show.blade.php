                        ...
                        <div class="col-md-6 col-lg-4 col-xl-2 pb-10">
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column pb-2 pl-1 pr-1 pt-4 ">
                                    <a href="{{ route('dms.show', [encryptId($principle->id), 'proposal_id' => encryptId($item->id), 'case_id' => encryptId($item->cases->first()->id), 'contractor_id' => encryptId($contractor_id), 'dmsable_type' => encryptId('Cases'), 'type' => encryptId('application_view')]) }}" class="text-gray-800 text-hover-primary d-flex flex-column" target="_blank">
                                ...
                                <div class="fs-5 fw-bold mb-2 text-center">{{ $item->code . '/V-' . $item->version }}</div>
