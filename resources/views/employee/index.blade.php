                    ...
                    <table class="table table-separate table-head-custom table-checkable" id="dataTableBuilder">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th>
                                    <div class="datatable-form-filter no-padding">
                                        {!! Form::text('designation', Request::get('designation', null), ['class' => 'form-control']) !!}
                                    </div>
                                </th>
                                <th></th>
                            </tr>
...
@section('scripts')
    <script type="text/javascript">
        ...
        let designation = "{{ __('employee.designation') }}";
            ...
            window.LaravelDataTables['dataTableBuilder'] = $('#dataTableBuilder').DataTable({
                ...
                "ajax": {
                    data: function(d) {
                        ...
                        d.designation = jQuery(".datatable-form-filter input[name='designation']").val();

                        d.designation_id = jQuery("select[name='designation_id']").val();
                    }
                },
