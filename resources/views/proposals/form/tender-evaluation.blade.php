...
@component('partials._subheader.subheader-v6', [
    'page_title' => $title,
    'back_action' => route('proposals.show',[$proposal_id]),
    'text' => __('common.back'),
])
@endcomponent
@php 
if($id > 0){
    $rating_score = $proposal->rating_score ?? null;
    ...
    $overall_capacity = null;
    $individual_capacity = null;
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="row">
                    ...
                    {!! Form::hidden('contractor_id', $tenderEvaluation->contractor_id) !!}
                    {!! Form::hidden('beneficiary_id', $tenderEvaluation->beneficiary_id) !!}
                    {!! Form::hidden('id', $id) !!}
...
@section('scripts')
    ...
    @include('proposals.form.tender-evaluation-script')
@endsection
@endsection
