@if (isset($invocation_notification))
    <div class="card-body pl-12">
        <table style="width:100%">
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                    {{ $invocation_notification->bond_number ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.contractor') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->proposal->contractor->company_name ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                    {{ $invocation_notification->proposal->beneficiary->company_name ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.project_name') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->proposal->pd_project_name ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                    {{ $invocation_notification->proposal->tender_id ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.bond_conditionality') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->bond_conditionality ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                    {{ custom_date_format($invocation_notification->bond_start_date, 'd/m/Y') ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.bond_end_date') }}
                </td>
                <td class="width_15em text-black">
                    {{ custom_date_format($invocation_notification->bond_end_date, 'd/m/Y') ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                    {{ $invocation_notification->bondType->name ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.proposal') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->proposal->code.'/V'.$invocation_notification->proposal->version ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ custom_date_format($invocation_notification->invocation_date, 'd/m/Y') ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.bond_amount') }} {{ $currencySymbol }}
                </td>
                <td class="width_15em text-black">
                   {{ numberFormatPrecision($invocation_notification->invocation_amount, 0) ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->invocation_ext ?? '-' }}
                </td>                            
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->officer_name ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.designation') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->officer_designation ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->officer_email ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.mobile') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->officer_mobile ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->officer_land_line ?? '-' }}
                </td>                            
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->incharge_name ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.designation') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->incharge_designation ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->incharge_email ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.mobile') }}
                </td>
                <td class="width_15em text-black">
                    {{ $invocation_notification->incharge_mobile ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->incharge_land_line ?? '-' }}
                </td>                            
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black">
                     {{ $invocation_notification->office_branch ?? '-' }}
                </td>
                <td class="width_15em text-light-grey">
                    {{ __('invocation_notification.attachment') }}
                </td>
                <td class="width_15em text-black">
                    {{-- @if (isset($invocation_notification_dms['invocation_notification_attachment']))
                        @foreach ($invocation_notification_dms['invocation_notification_attachment'] as $item)
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="100">
                                        @if (isset($invocation_notification_dms) &&
                                                isset($invocation_notification_dms['invocation_notification_attachment']) &&
                                                count($invocation_notification_dms['invocation_notification_attachment']) > 0)
                                            @foreach ($invocation_notification_dms['invocation_notification_attachment'] as $document)
                                                <div class="row">
                                                    <div class="col">
                                                        {{ $loop->iteration }}.
                                                        {{ $document->file_name }}
            ...
            <tr>
                ...
                <td class="width_15em text-black" colspan="3">
                     {{ $invocation_notification->office_address ?? '-' }}
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="width_15em text-black" colspan="3">
                     {{ $invocation_notification->remark ?? '-' }}
                </td>   
            </tr>
            <tr>
                <td>&nbsp;</td>
                    ...
                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div data-scroll="true" data-height="100">
                                    @if (isset($invocation_notification_dms) &&
                                            isset($invocation_notification_dms['notice_attachment']) &&
                                            count($invocation_notification_dms['notice_attachment']) > 0)
                                        @foreach ($invocation_notification_dms['notice_attachment'] as $document)
                                            <div class="row">
                                                <div class="col">
                                                    {{ $loop->iteration }}.
                                                    {{ $document->file_name }}
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="100">
                                        @if (isset($invocation_notification_dms) &&
                                                isset($invocation_notification_dms['contract_agreement']) &&
                                                count($invocation_notification_dms['contract_agreement']) > 0)
                                            @foreach ($invocation_notification_dms['contract_agreement'] as $document)
                                                <div class="row">
                                                    <div class="col">
                                                        {{ $loop->iteration }}.
                                                        {{ $document->file_name }}
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="100">
                                        @if (isset($invocation_notification_dms) &&
                                                isset($invocation_notification_dms['beneficiary_communication_attachment']) &&
                                                count($invocation_notification_dms['beneficiary_communication_attachment']) > 0)
                                            @foreach ($invocation_notification_dms['beneficiary_communication_attachment'] as $document)
                                                <div class="row">
                                                    <div class="col">
                                                        {{ $loop->iteration }}.
                                                        {{ $document->file_name }}
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="100">
                                        @if (isset($invocation_notification_dms) &&
                                                isset($invocation_notification_dms['legal_documents']) &&
                                                count($invocation_notification_dms['legal_documents']) > 0)
                                            @foreach ($invocation_notification_dms['legal_documents'] as $document)
                                                <div class="row">
                                                    <div class="col">
                                                        {{ $loop->iteration }}.
                                                        {{ $document->file_name }}
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div data-scroll="true" data-height="100">
                                        @if (isset($invocation_notification_dms) &&
                                                isset($invocation_notification_dms['any_other_documents']) &&
                                                count($invocation_notification_dms['any_other_documents']) > 0)
                                            @foreach ($invocation_notification_dms['any_other_documents'] as $document)
                                                <div class="row">
                                                    <div class="col">
                                                        {{ $loop->iteration }}.
                                                        {{ $document->file_name }}
