@extends($theme)
@section('title', __('facility_type.facility_type'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('facility_type.facility_type'),
        'add_modal' => collect([
            'action' => route('facility_type.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['facility_type.add', 'users.superadmin']),
    ])
    @endcomponent
...
@section('scripts')
    <script type="text/javascript">
        let name = "{{ __('facility_type.name') }}";
