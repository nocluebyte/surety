@extends($theme)
@section('title', __('ministry_types.ministry_types'))

@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => __('ministry_types.ministry_types'),
        'add_modal' => collect([
            'action' => route('ministry_types.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['ministry_types.add', 'users.superadmin']),
    ])
    @endcomponent
...
@section('scripts')
    <script type="text/javascript">
        let name = "{{ __('ministry_types.name') }}";
