...
@section('content')
    @component('partials._subheader.subheader-v6', [
        'page_title' => $title,
        'add_modal' => collect([
            'action' => route('agency.create'),
            'target' => '#commonModalID',
            'text' => __('common.add'),
        ]),
        'back_text' => __('common.back'),
        'model_back_action' => route('masterPages'),
        'permission' => $current_user->hasAnyAccess(['agency.add', 'users.superadmin']),
    ])
    @endcomponent
...
@section('scripts')
    <script type="text/javascript">
        let agency_name = "{{ __('agency.agency_name') }}";
        ...
        (function(window, $) {
            ...
            window.LaravelDataTables['dataTableBuilder'] = $('#dataTableBuilder').DataTable({
                ...
                "ajax": {
                    data: function(d) {
                        d.agency_name = jQuery(".datatable-form-filter input[name='agency_name']").val();
                    }
                },
