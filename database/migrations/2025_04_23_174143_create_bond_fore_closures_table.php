...
return new class extends Migration
{
    ...
    {
        Schema::create('bond_fore_closures', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('type_of_foreclosure_id')->nullable();
            $table->date('foreclosure_date')->nullable();
            $table->text('any_other_reasons')->nullable();
    ...
    {
        Schema::dropIfExists('bond_fore_closures');
    }
};
