...
return new class extends Migration
{
    ...
    {
        Schema::create('bid_bond_contractors', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->integer('bid_bond_id')->default(0);
            $table->string('bid_contractor_type')->nullable();
            $table->integer('bid_contractor_id')->default(0);
    ...
    {
        Schema::dropIfExists('bid_bond_contractors');
    }
};
