...
class CasesBondLimitStrategy extends MyModel
{
    use HasFactory;

    protected $table = 'cases_bond_limit_strategies';
    protected $revisionCleanup = true;
    protected $historyLimit = 500;
    protected $fillable = [
        "id","contractor_id","casesable_type","casesable_id","cases_action_plan_id","cases_id","bond_type_id","bond_current_cap","bond_utilized_cap","bond_utilized_cap_persontage","bond_remaining_cap","bond_remaining_cap_persontage","bond_proposed_cap","bond_valid_till","is_current","status","year_id","ip","update_from_ip","created_by","updated_by","deleted_at","created_at","updated_at"
    ];
