...
class TypeOfEntityDataTable extends DataTable
{
    /**
    ...
    public function checkrights($row)
    {
        ...
        $menu = '';
        $editUrl = route('type_of_entities.edit', [encryptId($row->id)]);
        $deleteUrl = route('type_of_entities.destroy', [encryptId($row->id)]);

        if($user -> hasAnyAccess(['users.info', 'type_of_entities.edit', 'type_of_entities.delete', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['type_of_entities.edit', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['type_of_entities.delete', 'users.superadmin']))
        {
     ...
     */
    public function query(TypeOfEntity $model)
    {
        $model = TypeOfEntity::select('type_of_entities.*');
    ...
    {
        return [
            ['name' => 'type_of_entities', 'data' => 'type_of_entities', 'title' => trans("type_of_entities.type_of_entities")],
    ...
    // {
    //     return 'TypeOfEntity_' . date('YmdHis');
    // }
}
