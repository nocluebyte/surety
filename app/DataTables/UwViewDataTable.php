...
class UwViewDataTable extends DataTable
{
    /**
    ...
    public function checkrights($row)
    {
        ...
        $menu = '';
        $editUrl = route('uw-view.edit', [$row->id]);
        $deleteUrl = route('uw-view.destroy', [$row->id]);

        if($user -> hasAnyAccess(['users.info', 'uw-view.edit', 'uw-view.delete', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['uw-view.edit', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['uw-view.delete', 'users.superadmin']))
        {
     ...
     */
    public function query(UwView $model)
    {
        $model = UwView::select('name', 'id', 'is_active');
