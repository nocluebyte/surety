...
class EstablishmentTypeDataTable extends DataTable
{
    /**
    ...
    public function checkrights($row)
    {
        ...
        $menu = '';
        $editUrl = route('establishment_types.edit', [encryptId($row->id)]);
        $deleteUrl = route('establishment_types.destroy', [encryptId($row->id)]);

        if($user -> hasAnyAccess(['users.info', 'establishment_types.edit', 'establishment_types.delete', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['establishment_types.edit', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['establishment_types.delete', 'users.superadmin']))
        {
     ...
     */
    public function query(EstablishmentType $model)
    {
        $model = EstablishmentType::select('establishment_types.*');
    ...
    {
        return [
            ['name' => 'establishment_types', 'data' => 'establishment_types', 'title' => trans("establishment_types.establishment_types")],
    ...
    // {
    //     return 'EstablishmentType_' . date('YmdHis');
    // }
}
