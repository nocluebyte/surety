...
class ReasonDataTable extends DataTable
{
    ...
    public function checkrights($row)
    {
        ...
        $menu = '';
        $editUrl = route('reason.edit', [encryptId($row->id)]);
        $deleteUrl = route('reason.destroy', [encryptId($row->id)]);

        if($user -> hasAnyAccess(['users.info', 'reason.edit', 'reason.delete', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['reason.edit', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['reason.delete', 'users.superadmin']))
        {
    ...
    {
        $model = Reason::select('reason', 'description', 'id', 'is_active');
