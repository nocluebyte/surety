...
class WorkTypeDataTable extends DataTable
{
    ...
    public function checkrights($row)
    {
        ...
        $menu = '';
        $editUrl = route('work-type.edit', [encryptId($row->id)]);
        $deleteUrl = route('work-type.destroy', [encryptId($row->id)]);

        if($user -> hasAnyAccess(['users.info', 'work_type.edit', 'work_type.delete', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['work_type.edit', 'users.superadmin']))
        {
        ...
        if($user -> hasAnyAccess(['work_type.delete', 'users.superadmin']))
        {
    ...
    {
        $model = WorkType::select('name', 'id', 'is_active');
    ...
    {
        return [
            ['name' => 'work_type', 'data' => 'work_type', 'title' => trans("work_type.work_type")],
